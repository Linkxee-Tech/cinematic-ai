...
export interface UseSupabaseUploadReturn {
  getRootProps: (opts?: object) => object;
  getInputProps: (opts?: object) => object;
  isDragActive: boolean;
  isDragReject: boolean;
  isSuccess: boolean;
  loading: boolean;
  files: Array<{ name: string; size: number; type: string; preview: string; errors: Array<{ message: string }> }>;
  setFiles: (files: UseSupabaseUploadReturn['files']) => void;
  onUpload: () => void;
  successes: string[];
